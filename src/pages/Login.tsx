                ...
                {/* Content overlay */}
                      <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
                                ...
                                <h1 className="text-center">
                                            <span className="font-display text-6xl text-white tracking-[0.08em] block leading-none">BRECHÓ</span>span>
                                            <span className="font-serif-italic text-4xl text-accent block mt-1">Peaogê</span>span>
                                </h1>h1>
                                <div
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-8 bg-background">
                      <div className="w-full max-w-sm space-y-8">
                        {/* Mobile logo */}
                                ...
                                <div>
                                            <h2 className="font-display text-4xl text-primary tracking-wide">ENTRAR</h2>h2>
                                            <p className="text-xs text-muted-foreground mt-1">Selecione seu perfil</p>p>
                                </div>div>
                        ...
                        <button
                                        ...
                                        <div>
                                                          <p className="font-display text-lg text-primary tracking-wide">{s.name.toUpperCase()}</p>p>
                                                          <p className="text-[10px] text-muted-foreground">{s.cargo}</p>p>
                                        </div>div>
                        </button>button>
                      ))}
                                </div>div>
                        ...
                        {/* Password */}
                                <div>
                                            <Label className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground">Senha</Label>Label>
                                            <Input
                                                            type="password"
                                                            value={senha}
