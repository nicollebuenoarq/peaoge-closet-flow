                            ...
                            <div
                                        ...
                                        <nav className="px-4 py-3 space-y-1 bg-background">
                                          {navItems.map((item) => {
                                                      ...
                                                      <button
                                                                        onClick={handleLogout}
                                                                        className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-bold tracking-[0.1em] text-muted-foreground hover:bg-muted transition-colors"
                                                                      >
          ...
          {/* Footer */}
              <footer className="border-t border-border bg-background">
                      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
                                <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Brechó Peaogê • v2.0</p>p>
                                <img
                                              src={logo}
                                              alt=""
